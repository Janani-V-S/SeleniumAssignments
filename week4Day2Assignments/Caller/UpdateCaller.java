package week4Day2Assignments.Caller;
...
public class UpdateCaller {
	...
	public static void main(String[] args) {
		//Login to ServiceNow Application
				...
				String newPhoneNum = "22222";
				driver.findElement(By.id("sys_user.phone")).clear();
				driver.findElement(By.id("sys_user.phone")).sendKeys(newPhoneNum);
				
				driver.findElement(By.id("sysverb_update")).click();
				
				//verify if caller is updated
				String updatedPhoneNo = driver.findElement(By.xpath("(//tr[@class = 'list_row list_odd']/td)[5]")).getText();
				
				if(updatedPhoneNo.equals(newPhoneNum)) {
					System.out.println("Caller is updated");
				}else {
					System.out.println("Caller is not updaed");
				}
				driver.close();
	}
}
