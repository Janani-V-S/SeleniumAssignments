...
public class OrderingMobile {
	...
	public static void main(String[] args) {
				...
				if(driver.findElement(By.xpath("//span[text() = 'Thank you, your request has been submitted']")).isDisplayed()) {
					System.out.println("Order is placed");
					String  orderID = driver.findElement(By.id("requesturl")).getText();
					System.out.println("Order Id - "+driver.findElement(By.id("requesturl")).getText());
				}else {
